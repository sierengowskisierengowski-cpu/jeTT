...
if python3 coverage/zero_gate.py --coverage data/mitre_coverage.json; then
...
echo "    Train: JETT_TRAINING_DATA=data/jett_training_v4.json python3 train_core_weights.py"
