...
$SSH "mkdir -p $REMOTE/data $REMOTE/models/r8 $REMOTE/outputs/r8 $REMOTE/scripts $REMOTE/src $REMOTE/coverage $REMOTE/tests"
...
rsync -az -e "$RSYNC_SSH" --no-owner --no-group tests/guard_eval_v8.jsonl "$USER@$HOST:$REMOTE/tests/"
